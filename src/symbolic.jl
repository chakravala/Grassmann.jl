...
for (op,set) ∈ [(:add,:(+=)),(:set,:(=))]
    ...
    @eval begin
        ...
        @inline function $(Symbol(:join,sm))(V::VectorSpace{N,D},m::SizedArray{Tuple{M},T,1,1},v::T,A::UInt16,B::Bits) where {N,D,T<:SymField,M}
