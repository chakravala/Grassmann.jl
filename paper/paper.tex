...
It is possible to reach \verb`Basis` elements with up to $n=62$ indices, % with \verb`TensorAlgebra` having higher maximum dimensions than supported by Julia natively.
