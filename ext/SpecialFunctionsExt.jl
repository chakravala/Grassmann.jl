...
for fun ∈ (:polygamma,:gamma,:loggamma,:beta,:logbeta,:logabsbeta,:logabsbinomial,:expint,:erf,:besselj,:besseljx,:sphericalbesselj,:bessely,:besselyx,:sphericalbessely,:hankelh1,:hankelh1x,:hankelh2,:hankelh2x,:besseli,:besselix,:besselk,:besselkx)
    @eval begin
        SpecialFunctions.$fun(x,y::TensorTerm{V}) where V = SpecialFunctions.$fun(x,Couple(y))
        SpecialFunctions.$fun(x,y::TensorTerm{V,0}) where V = Single{V}(SpecialFunctions.$fun(x,Real(y)))
        SpecialFunctions.$fun(x,y::Couple{V,B}) where {V,B} = Couple{V,B}(SpecialFunctions.$fun(x,Complex(y)))
        SpecialFunctions.$fun(x,y::Chain) = vectorize(SpecialFunctions.$fun(x,complexify(y)))
        SpecialFunctions.$fun(x,y::Phasor) = SpecialFunctions.$fun(x,complexify(y))
        SpecialFunctions.$fun(x::TensorTerm{V},y) where V = SpecialFunctions.$fun(Couple(x),y)
        SpecialFunctions.$fun(x::TensorTerm{V,0},y) where V = Single{V}(SpecialFunctions.$fun(Real(x),y))
        SpecialFunctions.$fun(x::Couple{V,B},y) where {V,B} = Couple{V,B}(SpecialFunctions.$fun(Complex(x),y))
        SpecialFunctions.$fun(x::Chain,y) = vectorize(SpecialFunctions.$fun(complexify(x),y))
        SpecialFunctions.$fun(x::Phasor,y) = SpecialFunctions.$fun(complexify(x),y)
...
SpecialFunctions.gamma_inc(x::TensorTerm{V},y,z) where V = SpecialFunctions.gamma_inc(Couple(x),y,z)
SpecialFunctions.gamma_inc(x::TensorTerm{V,0},y,z) where V = Single{V}(SpecialFunctions.gamma_inc(Real(x),k,z))
SpecialFunctions.gamma_inc(x::Couple{V,B},y,z) where {V,B} = Couple{V,B}(SpecialFunctions.gamma_inc(Complex(x),y,z))
SpecialFunctions.gamma_inc(x::Chain,y,z) = vectorize(SpecialFunctions.gamma_inc(complexify(x),y,z))
SpecialFunctions.gamma_inc(x::Phasor,y,z) = SpecialFunctions.gamma_inc(complexify(x),y,z)
SpecialFunctions.gamma_inc(x,y::TensorTerm{V},z) where V = SpecialFunctions.gamma_inc(Couple(x),y,z)
SpecialFunctions.gamma_inc(x,y::TensorTerm{V,0},z) where V = Single{V}(SpecialFunctions.gamma_inc(Real(x),y,z))
SpecialFunctions.gamma_inc(x,y::Couple{V,B},z) where {V,B} = Couple{V,B}(SpecialFunctions.gamma_inc(Complex(x),y,z))
SpecialFunctions.gamma_inc(x,y::Chain,z) = vectorize(SpecialFunctions.gamma_inc(complexify(x),y,z))
SpecialFunctions.gamma_inc(x,y::Phasor,z) = SpecialFunctions.gamma_inc(complexify(x),y,z)
SpecialFunctions.gamma_inc(x::TensorTerm{V},y::TensorTerm{V},z) where V = SpecialFunctions.gamma_inc(Couple(x),Couple(y),z)
SpecialFunctions.gamma_inc(x::TensorTerm{V,0},y::TensorTerm{V,0},z) where V = Single{V}(SpecialFunctions.gamma_inc(Real(x),Real(y),z))
SpecialFunctions.gamma_inc(x::TensorTerm{V},y::TensorTerm{V,0},z) where V = SpecialFunctions.gamma_inc(Couple(x),Real(y),z)
SpecialFunctions.gamma_inc(x::TensorTerm{V,0},y::TensorTerm{V},z) where V = SpecialFunctions.gamma_inc(Real(x),Couple(y),z)
SpecialFunctions.gamma_inc(x::Couple{V,B},y::Couple{V,B},z) where {V,B} = Couple{V,B}(SpecialFunctions.gamma_inc(Complex(x),Complex(y),z))
SpecialFunctions.gamma_inc(x::Couple{V,B},y::TensorTerm{V,0},z) where {V,B} = SpecialFunctions.gamma_inc(x,Real(y),z)
SpecialFunctions.gamma_inc(x::Couple{V,B},y::TensorTerm{V},z) where {V,B} = SpecialFunctions.gamma_inc(x,Couple(y),z)
SpecialFunctions.gamma_inc(x::TensorTerm{V,0},y::Couple{V,B},z) where {V,B} = SpecialFunctions.gamma_inc(Real(x),y,z)
SpecialFunctions.gamma_inc(x::TensorTerm{V},y::Couple{V,B},z) where {V,B} = SpecialFunctions.gamma_inc(Couple(x),y,z)
