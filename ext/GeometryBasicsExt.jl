...
Base.convert(::Type{GeometryBasics.Point},t::T) where T<:Couple = GeometryBasics.Point(Grassmann.vectorize(t))
Base.convert(::Type{GeometryBasics.Point},t::T) where {V,T<:Phasor{V,<:TensorGraded}} = GeometryBasics.Point(Grassmann.vectorize(t))
